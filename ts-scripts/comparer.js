...
const ts_treemap_1 = __importDefault(require("ts-treemap"));
...
function getAllTokens(file_name, program) {
    let tokens = new ts_treemap_1.default();
...
function getTypesFromTypeScript(checker, sourceFile) {
    var tokens = [];
...
function identifyTokens(sourcefile) {
    let tokens = [];
    function nodeChecker(node) {
